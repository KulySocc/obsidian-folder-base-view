...
Obsidian 1.9+ (desktop) with the core **Bases** plugin enabled.

## Setup

1. **Settings → Folder Index → Create recommended Index Base** (one click) — or pick any `.base` as the Default Index Base.
